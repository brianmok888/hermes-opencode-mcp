...
# Legacy Hermes-opencode-bridge skill

Use this preserved copy when you need the original bridge-oriented onboarding/ops guidance during migration or cleanup.
